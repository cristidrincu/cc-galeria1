<?  
    ...
    if(isset($_POST['submitBtn']) && $_POST['submitBtn']=="Trimite") {   
		...
		if($captcha->check_captcha($_POST['public_key'],$_POST['private_key']))	 { 
				$contactErrorMessage = checkSuggestionForm($_POST); 
				if($contactErrorMessage=="") {
					...
					$htmlText .=   '    <td colspan="2">Cerere Sugestie</td>';
					$htmlText .=   '</tr>';
					$htmlText .=   '<tr>';
					...
					$text  =   'Cerere Sugestie\r\n';
					$text .=   'Nume:'.$name.'\r\n';
					$text .=   'Email:'.$email.'\r\n';
					$text .=   'Mesaj:'.nl2br($message).'\r\n';
		
					$to=SUGGESTION_DELIVERY_ADDRESS;                                                            
					$from = "client@ccgaleria1.ro";
					$subject = "Cerere Sugestie";    
...
<head>
	...
	<title>Galeria 1 - Sugestii</title>
</head>
<body>
	...
	<div id="mainBox">
	  ...
	  <div id="rightColumn">
			...
			<div class="containerTextRightColumn">
				<ul style="list-style:none; margin-left:-10x !important; margin-left:0; font-weight:bold; color:#990000; margin-bottom:-10px !important; margin-bottom:7px;">
					<li>SORAZMI</li>
